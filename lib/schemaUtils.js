  ...
  */
  ...
  getAuthHelper: function(openapi, securitySet) {
    ...
    _.forEach(securitySet, (security) => {
      ...
      else if (securityDef.type === 'apiKey' && securityDef['x-cko-type'] === 'secretKey') {
        helper = {
          type: 'apikey',
          apikey: [
            {
      ...
      else if (securityDef.type === 'apiKey' && securityDef['x-cko-type'] === 'publicKey') {
        helper = {
          type: 'apikey',
          apikey: [
            {

...
describe('openapi2postmanv2 ', function() {
  ...
  it('should print to console', function(done) {
    exec('./bin/ckoopenapi2postmanv2.js -s test/data/valid_openapi/petstore.json', function(err, stdout) {
  ...
  it('should print to file', function(done) {
    exec('./bin/ckoopenapi2postmanv2.js -s test/data/valid_openapi/petstore.json -o tempOutput.json', function(err) {
      expect(err).to.be.null;
  ...
  it('should show appropriate messages for invalid input', function (done) {
    exec('./bin/ckoopenapi2postmanv2.js -s test/data/invalid_openapi/multiple-components.yaml', function(err, stdout) {
      expect(err).to.be.null;
